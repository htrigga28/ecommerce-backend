...
var updateUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, user, _a, firstName, lastName, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                user.fullName = "".concat(user.firstName, " ").concat(user.lastName);
            ...
            case 4:
                err_1 = _b.sent();
                return [2 /*return*/, res.status(404).json({ message: 'User not found', error: err_1 })];
